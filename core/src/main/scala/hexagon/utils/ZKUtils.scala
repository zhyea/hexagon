...
object ZKUtils extends Logging {
  ...
  /**
    * Update the persistence path with the given data.
    * Create parent path if necessary.
    */
  def updatePersistencePath(zkClient: ZkClient, path: String, data: String): Unit = {
    try {
  ...
  /**
    * Update the ephemeral path with the given data.
    * Create parent path if necessary. Never throw NodeExistsException.
    */
  def updateEphemeralPath(zkClient: ZkClient, path: String, data: String): Unit = {
    try {
